...
def main():
    ...
    st.title("Predição de sujeira em câmeras de videomonitoramento")
    st.write("Essa aplicação utiliza inteligência artificial para detectar sujeira em imagens de videomonitoramento")
